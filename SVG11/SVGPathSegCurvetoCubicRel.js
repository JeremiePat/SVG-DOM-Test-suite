(function(){
	...
	NODE = PATH.createSVGPathSegCurvetoCubicRel(1,1,1,1,1,1);
	
	// Building the test suite object
	testDefinition = {
		info : {
			title : 'SVGPathSegCurvetoCubicRel',
			comment : 'SVGPathSegCurvetoCubicRel corresponds to an "relative cubic Bézier curveto" (c) path data command.'
		},
		test : [
			function() {
				var out = {
				    	title: "Check the existance of the SVGPathSegCurvetoCubicRel object definition",
				    	comment: "", 
				    	result: 0
				    }
				
				try{
				    out.result = (NODE && typeof SVGPathSegCurvetoCubicRel != 'undefined' && NODE instanceof SVGPathSegCurvetoCubicRel && 1) || 0;
				} catch(e) {
			...
			function() {
				var out = {
				    	title: "SVGPathSegCurvetoCubicRel also implement SVGPathSeg",
				    	comment: "", 
				    	result: 0
				    }
