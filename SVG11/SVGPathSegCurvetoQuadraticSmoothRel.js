(function(){
	...
	NODE = PATH.createSVGPathSegCurvetoQuadraticSmoothRel(1,1);
	
	// Building the test suite object
	testDefinition = {
		info : {
			title : 'SVGPathSegCurvetoQuadraticSmoothRel',
			comment : 'SVGPathSegCurvetoQuadraticSmoothRel corresponds to a "relative smooth cubic curveto" (t) path data command.'
		},
		test : [
			function() {
				var out = {
				    	title: "Check the existance of the SVGPathSegCurvetoQuadraticSmoothRel object definition",
				    	comment: "", 
				    	result: 0
				    }
				
				try{
				    out.result = (NODE && typeof SVGPathSegCurvetoQuadraticSmoothRel != 'undefined' && NODE instanceof SVGPathSegCurvetoQuadraticSmoothRel && 1) || 0;
				} catch(e) {
			...
			function() {
				var out = {
				    	title: "SVGPathSegCurvetoQuadraticSmoothRel also implement SVGPathSeg",
				    	comment: "", 
				    	result: 0
				    }
