(function(){
	...
	NODE = PATH.createSVGPathSegCurvetoCubicAbs(1,1,1,1,1,1);
	
	// Building the test suite object
	testDefinition = {
		info : {
			title : 'SVGPathSegCurvetoCubicAbs',
			comment : 'SVGPathSegCurvetoCubicAbs corresponds to an "absolute cubic Bézier curveto" (C) path data command.'
		},
		test : [
			function() {
				var out = {
				    	title: "Check the existance of the SVGPathSegCurvetoCubicAbs object definition",
				    	comment: "", 
				    	result: 0
				    }
				
				try{
				    out.result = (NODE && typeof SVGPathSegCurvetoCubicAbs != 'undefined' && NODE instanceof SVGPathSegCurvetoCubicAbs && 1) || 0;
				} catch(e) {
			...
			function() {
				var out = {
				    	title: "SVGPathSegCurvetoCubicAbs also implement SVGPathSeg",
				    	comment: "", 
				    	result: 0
				    }
