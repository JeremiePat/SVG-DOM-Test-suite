(function(){
	...
	NODE = PATH.createSVGPathSegCurvetoCubicSmoothAbs(1,1,1,1);
	
	// Building the test suite object
	testDefinition = {
		info : {
			title : 'SVGPathSegCurvetoCubicSmoothAbs',
			comment : 'SVGPathSegCurvetoCubicSmoothAbs corresponds to an "absolute smooth cubic curveto" (S) path data command.'
		},
		test : [
			function() {
				var out = {
				    	title: "Check the existance of the SVGPathSegCurvetoCubicSmoothAbs object definition",
				    	comment: "", 
				    	result: 0
				    }
				
				try{
				    out.result = (NODE && typeof SVGPathSegCurvetoCubicSmoothAbs != 'undefined' && NODE instanceof SVGPathSegCurvetoCubicSmoothAbs && 1) || 0;
				} catch(e) {
			...
			function() {
				var out = {
				    	title: "SVGPathSegCurvetoCubicSmoothAbs also implement SVGPathSeg",
				    	comment: "", 
				    	result: 0
				    }
